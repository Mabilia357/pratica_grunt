...
const numeros = document.querySelectorAll('[id*=tecla]'); //seleciona as teclas atraves do [id*=tecla]
const operadores = document.querySelectorAll('[id*=operador]'); // sleciona teclas atraves do [id*=operador]
